...
class $AssetsIconsGen {
  ...
  /// List of all assets
  List<SvgGenImage> get values => [apple, email, goodDeeds, google, left, logo];
}
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/info_one.svg
  SvgGenImage get infoOne => const SvgGenImage('assets/images/info_one.svg');

  /// File path: assets/images/info_three.svg
  SvgGenImage get infoThree =>
      const SvgGenImage('assets/images/info_three.svg');
