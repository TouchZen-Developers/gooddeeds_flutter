...
class DonaitingNotificationSettingsScreen extends StatelessWidget {
  const DonaitingNotificationSettingsScreen({super.key});
          ...
          child: Column(
            children: [
              _NotificationSetting(
                title: context.loc.deliveryConfirmation,
                desc: context.loc.deliveryConfirmationDesc,
              ),
              const Gap(12),
              _NotificationSetting(
                title: context.loc.familiesNearYou,
                desc: context.loc.familiesNearYouDesc,
              ),
              const Gap(12),
              _NotificationSetting(
                title: context.loc.recentEmergencies,
                desc: context.loc.recentEmergenciesDesc,
              ),
            ],
          ),
        ),
