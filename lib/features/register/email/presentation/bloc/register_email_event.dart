...
class RegisterEmailEvent with _$RegisterEmailEvent {
  ...
  const factory RegisterEmailEvent.passwordChanged(String password) = _PasswordChanged;
  const factory RegisterEmailEvent.confirmPasswordChanged(String confirmPassword) = _ConfirmPasswordChanged;
