...
sealed class RegisterChoiceEvent with _$RegisterChoiceEvent {
  const factory RegisterChoiceEvent.needDonationsPressed() = _NeedDonationsPressed;
  const factory RegisterChoiceEvent.helpFamiliesPressed() = _HelpFamiliesPressed;
